...
void LinkedList::insertNode(int data){
	...
	make the last item in the linked list have a null pointer because no new instance of node has been created
    hence we are able to traverse through that one instance of linkedlist. the temp varable will point to the last node.remember 
	that the last node is characterised by its pointer being null. 
	*/
